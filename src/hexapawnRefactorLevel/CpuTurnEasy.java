...
public class CpuTurnEasy {
	public static int[] CpuTurnEasy(int[][] field, int[][]selectButtun, int round) {
		...
		int easy = new Random().nextInt(2); //斜めに移動するパターンを選択する確率を半分にする。(65・78・92行目参照。)
